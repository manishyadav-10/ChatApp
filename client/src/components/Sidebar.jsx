    ...
    ${selectedUser ? "max-md:hidden" : '' }`}>
      <div className='pd-5'>
        ...
        mt-5'>
            ...
            text-white text-xs placeholder-[#c8c8c8] flex-1' placeholder='Sarch User...'/>
...
<div className='flex flex-col'>
 {filteredUsers.map((user,index)=>(
    ...
    'bg-[#282142]/50'}`}>
        <img src={user?.profilePic || assets.avatar_icon } alt='img' 
        ...
        <div className='flex flex-col leading-5'>
            ...
            {
              unseenMessages[user._id]>0 && <p className='absolute top-4 right-4 text-xsh-5 w-5
